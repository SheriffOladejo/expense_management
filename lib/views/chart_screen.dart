        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Text("${formatter.format(widget.data.trading_vol)}", style: TextStyle(
                color: Colors.white,
                fontSize: 12,
                fontFamily: 'inter-medium',
                fontWeight: FontWeight.w500,
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Text("${formatter.format(widget.data.circulating_supply)}", style: TextStyle(
                color: Colors.white,
                fontSize: 12,
                fontFamily: 'inter-medium',
                fontWeight: FontWeight.w500,
          ...
          Row(
            ...
            children: [
              ...
              Text("${formatter.format(widget.data.max_supply)}", style: TextStyle(
                color: Colors.white,
                fontSize: 12,
                fontFamily: 'inter-medium',
                fontWeight: FontWeight.w500,
          ...
          Row(
            ...
            children: [
              ...
              Text("${formatter.format(widget.data.total_supply)}", style: TextStyle(
                color: Colors.white,
                fontSize: 12,
                fontFamily: 'inter-medium',
                fontWeight: FontWeight.w500,
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Text("${formatter.format(widget.data.market_cap)}", style: TextStyle(
                color: Colors.white,
                fontSize: 12,
                fontFamily: 'inter-medium',
                fontWeight: FontWeight.w500,
          ...
          Row(
            ...
            children: [
              ...
              Text("${formatter.format(widget.data.market_cap_rank)}", style: TextStyle(
                color: Colors.white,
                fontSize: 12,
                fontFamily: 'inter-medium',
                fontWeight: FontWeight.w500,
